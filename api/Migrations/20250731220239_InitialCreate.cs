        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlockedDates_Villas_VillaId",
                        column: x => x.VillaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReservationFeeAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ReservationCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
